...
{
    [SerializeField] private Button unlocked;//Default value is false;
    ...
    {
        if(unlocked.interactable == false)//MARKER if unclock is false means This level is clocked!
        {
